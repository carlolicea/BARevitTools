...
namespace BARevitTools.ToolRequests.ToolRequests
{
    class MaterialsAMLRequest
    {
        ...
        {
            DataGridView dgv = BARevitTools.ToolRequests.Application.thisApp.newMainUi.materialsAMLDataGridView;
            ...
            BARevitTools.ToolRequests.Application.thisApp.newMainUi.MaterialsAMLUpdateDGV(dgv);
            ...
            BARevitTools.ToolRequests.Application.thisApp.newMainUi.materialsAMLPalette.paletteMaterialComboBox.Items.Add("Default");
            foreach (DataGridViewRow row in dgv.Rows)
            {
            ...
            if (materialsToUseList.Count != 0)
            {
                ...
                {
                    BARevitTools.ToolRequests.Application.thisApp.newMainUi.materialsAMLPalette.paletteMaterialComboBox.Items.Add(item);
                }
            }
            else
            {
                BARevitTools.ToolRequests.Application.thisApp.newMainUi.materialsAMLPalette.paletteMaterialComboBox.Text = "Default";
                BARevitTools.ToolRequests.Application.thisApp.newMainUi.materialsAMLPalette.paletteMaterialComboBox.Enabled = false;
            }

            BARevitTools.ToolRequests.Application.thisApp.newMainUi.materialsAMLPalette.Show();
        }
    }
}
