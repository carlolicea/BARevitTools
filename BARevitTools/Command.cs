    ...
    public class Launcher : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elementSet)
        {
            try
            {
                ...
                commandData.Application.ActiveUIDocument.Document.Application.FailuresProcessing += new EventHandler<Autodesk.Revit.DB.Events.FailuresProcessingEventArgs>(RVTFailuresProcessor.OnFailuresProcessing);
